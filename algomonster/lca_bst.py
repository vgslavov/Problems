...
class TestLCAOnBST(unittest.TestCase):
    def test_lca_on_bst(self):
        ...
        self.assertEqual(lca_bst(bst, 2, 8), 6)

        # Test case 2: LCA of 2 and 4
        self.assertEqual(lca_bst(bst, 2, 4), 2)

        # Test case 3: LCA of 3 and 5
        self.assertEqual(lca_bst(bst, 3, 5), 4)

        # Test case 4: LCA of 7 and 9
        self.assertEqual(lca_bst(bst, 7, 9), 8)

        # Test case 5: LCA of 2 and 3
        self.assertEqual(lca_bst(bst, 2, 3), 2)

        # Test case 6: LCA of 4 and 5
        self.assertEqual(lca_bst(bst, 4, 5), 4)
